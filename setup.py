...
ext_modules = [
    Extension(
        ...
        sources=[
            "aerobulk/aerobulk/src/mod_const.f90",
            "aerobulk/aerobulk/src/mod_phymbl.f90",
            "aerobulk/aerobulk/src/mod_skin_coare.f90",
            "aerobulk/aerobulk/src/mod_skin_ecmwf.f90",
            "aerobulk/aerobulk/src/mod_blk_andreas.f90",
            "aerobulk/aerobulk/src/mod_common_coare.f90",
            "aerobulk/aerobulk/src/mod_blk_coare3p0.f90",
            "aerobulk/aerobulk/src/mod_blk_coare3p6.f90",
            "aerobulk/aerobulk/src/mod_blk_ecmwf.f90",
            "aerobulk/aerobulk/src/mod_blk_ncar.f90",
            "aerobulk/aerobulk/src/mod_blk_neutral_10m.f90",
            "aerobulk/aerobulk/src/mod_aerobulk_compute.f90",
            "aerobulk/aerobulk/src/mod_aerobulk.f90",
            "aerobulk/mod_aerobulk_wrap.f90",
            "aerobulk/mod_aerobulk_wrap.pyf",
        ],
...
setup(
    ...
    use_scm_version={
        ...
        "write_to": "aerobulk/_version.py",  # I would like to rename src to aerobulk similar to gsw at some point.
